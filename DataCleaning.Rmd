...
curve(1-pweibull(x, shape = 1/0.0499, scale = exp(4.55815)), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "purple", add = TRUE)

curve(1-pexp(x, rate = 1/exp(6.7426)), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "orange", add = TRUE)

curve(1-pnorm(x, mean = 93.7955, sd = 7.07), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "red", add = TRUE)

curve(1-plnorm(x, meanlog = 4.5439, sdlog = 0.083), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "blue", add = TRUE)
```
...
curve(1-pweibull(x, shape = 1/0.0518, scale = exp(4.59661)), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "purple", add = TRUE)

curve(1-pexp(x, rate = 1/exp(7.2927)), xlim= c(min(toilet$age), max(toilet$age)), ylab="Survival", xlab = "Age", col = "orange", add = TRUE)

curve(1-pnorm(x, mean = 97.8159, sd = 8), xlim= c(min(toilet$age), max(toilet$age)), ylab="Survival", xlab = "Age", col = "red", add = TRUE)

curve(1-plnorm(x, meanlog = 4.58936, sdlog = 0.0927), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "blue", add = TRUE)
```
...
```{r}
curve(1-pexp(x, 1/exp(6.742626)),ylim = c(0,1), xlim= c(min(bath$age), max(bath$age)), ylab="Survival", xlab = "Age", col = "orange")
```
#==================================
