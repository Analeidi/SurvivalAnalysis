...
aging <- aging %>%
  ...
  # mutate(see_children = ifelse(SEECHL2 == c(000,011,012,013,021,022,031,032,041,042,051,061,071,081,091,101,111,121,131),"1 month or less",ifelse(SEECHL2 == c(014,)))
...
plot(KMeatdistance, conf.int= FALSE, ylab="Survival" , xlab="Age", xlim = c(min(bath$age), max(bath$age)), ylim = c(0,1), col = c("blue", "red", "green","orange"))
```
