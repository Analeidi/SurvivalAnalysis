...
AIC to test normal vs. log-normal model (which is a better fit to our data):
```{r}
#AIC = 2(P-L)
...
The AICs are quite similar for both models, meaning they provide a similar fit, but the log-normal model has a slightly smaller AIC, so we would go with that model for our data.
