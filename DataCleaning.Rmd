...
We have to first filter out participants that were the following:
 ...
 Acceptable patients:
 -Start off independent regardless of year (so 3->1, 1, ""->1, 3->3->1, 3->""->1,""->3->1)
```{r}
#acceptable scenarios
data.frame("1986" = c(1,1,1,3,3,3,"",3,"","",""), "1988" = c(1,1,2,3,1,1,1,"",3,1,""), "1990" = c(1,2,2,1,1,2,2,1,1,1,1))
```
...
#Colleen's attempt at new filtering based on my table
bathDataC <- aging %>% filter(BATH2R != "2" & (BATH4R != "") & (BATH4R != "3") & !(BATH3R == "2" & BATH4R == "1"))
```
