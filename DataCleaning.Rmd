...
text(75, 0.4, "log-rank < .01")
title("KM Curves for Bathing, Eating, and Toileting Dependence")
legend(70, 0.8, legend=c("Bathing", "Eating", "Toileting"),
...
text(75, 0.4, "log-rank < .001")
title("KM Curves for Bathing Dependence by Race")
legend(72, 0.8, legend=c("White", "Black"),
       col=c("red", "blue", "purple"), lty = 1, cex = 0.8)
```
...
text(79, 0.4, "log-rank = 0.2")
title("KM Curves for Bathing Dependence by Income (1984)")
...
title("KM Curves for Bathing Dependence by Health Status (1984)")
...
title("KM Curves for Toileting Dependence by Health Status (1984)")
legend(72, 0.8, legend=c("Good", "Bad"),
       col=c("blue", "red"), lty = 1, cex = 0.8)
...
title("KM Curves for Eating Dependence by Health Status (1984)")
...
title("KM Curves for Bathing Dependence by Past Stroke")
...
title("KM Curves for Toileting Dependence by Past Stroke")
...
title("KM Curves for Eating Dependence by Past Stroke")
